        ...
        <div className="grid gap-1.5">
          {payload.map((item, index: number) => {
            ...
            const indicatorColor =
                color || (p.fill as string | undefined) || item.color;
            ...
            return (
                ...
                >
                  {formatter && hasValue && itemName ? (
                      formatter(item.value, itemName, item, index, item.payload as Record<string, unknown> | undefined)
                  ) : (
                      <>
                        {itemConfig?.icon ? (
                            <itemConfig.icon />
