package rs.master.o2c.auth.api.error;
...
public class GlobalExceptionHandler {
    ...
    public Mono<ResponseEntity<ApiErrorResponse>> handleAccessDenied(ServerHttpRequest request) {
        return Mono.just(build(HttpStatus.FORBIDDEN, "Forbidden", request, null));
    }

    @ExceptionHandler(Exception.class)
    public Mono<ResponseEntity<ApiErrorResponse>> handleUnhandled(ServerHttpRequest request) {
